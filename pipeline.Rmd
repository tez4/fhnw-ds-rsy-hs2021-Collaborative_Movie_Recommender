...
# Number of raitings per user per raiting value
...
r_m <- normalize(MovieLense)
getRatingMatrix(r_m)
image(r_m, main = "Normalized Ratings")
hist(getRatings(r_m), breaks=100)

r_m_z <- normalize(MovieLense, method="Z-score")
hist(getRatings(r_m_z), breaks=100)
...
ggplot(df2, aes(x=item, y=user, colour=rating)) + geom_point(alpha=0.02) + theme_classic()
