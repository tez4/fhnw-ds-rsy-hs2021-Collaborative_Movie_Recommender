...
```{r}
print('Old Matrix')
print(paste('Sparsity:', nratings(MovieLense) / (dim(MovieLense)[1] * dim(MovieLense)[2])))
print('')
print('New Matrix')
print(paste('Sparsity:', nratings(ratingMatrix) / (dim(ratingMatrix)[1] * dim(ratingMatrix)[2])))
