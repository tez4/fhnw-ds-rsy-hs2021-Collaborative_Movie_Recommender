...
p1 <- show_change_of_rating_distribution(MovieLense, dense_matrix, 'Für dense_matrix und N = 700 Filme')
p2 <- show_change_of_rating_distribution(MovieLense, dense_user_matrix, 'Für dense_user_matrix und N = 700 Filme')
p3 <- show_change_of_rating_distribution(MovieLense, random_matrix, 'Für random_matrix und N = 700 Filme')
